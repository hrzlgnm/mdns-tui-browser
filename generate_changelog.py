...
def generate_full_changelog(repository="hrzlgnm/mdns-tui-browser"):
...
def insert_section_into_changelog(section, repository="hrzlgnm/mdns-tui-browser"):
